                ...
                <div class="featured-content-home">
                    <div class="featured-image-home">
                        ...
                        {% elsif featured_home_post.title contains "Sam" %}
                          <img src="{{ site.baseurl }}/assets/images/sampaper2026/d6ra04633a-ga.jpg" alt="{{ featured_home_post.title }}" class="featured-img-home">
                        ...
                        {% elsif featured_home_post.title contains "PhD Scholarship" %}
                          <img src="{{ site.baseurl }}/assets/images/newjosh.jpg" alt="{{ featured_home_post.title }}" class="featured-img-home">
